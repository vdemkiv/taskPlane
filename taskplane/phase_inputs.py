"""Shared stateless phase inputs, task selection, and assignment contracts.

This module owns no authoring, quality execution, integration, or completion
mutation. Plan, quality, and pickup depend on this seam, never on one another
for their shared refusal and assignment types.
"""
...
if TYPE_CHECKING or __package__:
    from . import checkpoint, design_contract, phase_handoff, review_evidence
...
def select_ready_build_task(
    ...
    validate_obligation_ownership(checked, checked["tasks"])
