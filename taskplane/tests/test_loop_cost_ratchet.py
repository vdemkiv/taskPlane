...
class TestTheHarnessMeasuresTheRealLoop(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        # The measurement drives a complete miniature loop. Run it once for
        # this class; repeating it per assertion only multiplied CI work.
        with mock.patch.dict(os.environ, {}, clear=False):
            cls.got = ci_loop_cost.measure()
