...
| **v2.17.24** | **Superseded local candidate — not released.** Applied the minimal R-0013 bootstrap correction: W31 uses the Codex-native producer-consumer path, and execution-time EM honors governed zero-lens delivery instead of requiring a lens producer. It was compatibility N-1 for v2.17.25 and was never promoted into released truth. |
## Install
