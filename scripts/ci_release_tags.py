...
NOT_RELEASED = {
    "2.23.10": {
        "reason": "untagged review recovery source candidate; native source review "
                  "simplification supersedes it in 2.24.0. Local archives and "
                  "CI do not establish marketplace or tagged publication.",
    ...
    "2.23.8": {
        "reason": "untagged native startup and budget recovery source candidate; "
                  ...
                  "corrections supersede it in 2.23.9. Marketplace "
                  "installation is separate from a tagged source release.",
    ...
    "2.23.4": {
        "reason": "untagged standalone review startup candidate; local archives "
                  ...
                  "release. Session isolation and cross-checkout readiness "
                  "are repaired in the 2.23.5 candidate.",
        "superseded_by": "2.23.5",
    },
    "2.23.3": {
        "reason": "untagged harness candidate on main; archive preparation and "
                  "local installation did not establish a version tag or "
                  "GitHub release. The standalone startup repair is prepared "
                  "as the 2.23.4 candidate.",
    ...
    "2.23.1": {
        "reason": "superseded untagged onboarding source candidate. Its fixes "
                  ...
                  "local installation did not establish a tagged release.",
