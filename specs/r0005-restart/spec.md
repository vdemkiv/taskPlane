...
Retain unresolved input dependencies **R-0001 and R-0003**. R-0004 remains historical rather than a separate active dependency because its applicable obligations are incorporated into R-0001. Their history is preserved; this draft does not verify satisfaction or import completion. R-0005 is the requirements input, not evidence of an approved current Design.
