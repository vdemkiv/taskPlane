...
10. Stop and return the artifacts to the orchestrator. It alone calls the Design DoD gate. In a delivery loop, the consolidated human implementation approval follows the Plan gate; a standalone Design ends at its human approval. Never approve, plan, implement, or fix your own design.
