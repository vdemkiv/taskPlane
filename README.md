...
> superseded unreleased candidates. v2.19.0 and v2.19.1 are superseded by the
> v2.19.2 wiring-repair candidate, which is not released. Historical
...
> Preparing, validating, or merging v2.19.2 is not a tag, upload,
> Marketplace publication, installation, or release claim; those actions
> retain separate human authority.

| Version | Highlights |
| --- | --- |
| **v2.19.2** | **Phase handoff wiring — release candidate, not released.** Connects native Design/Plan output, focused review, initial Requirement export, and Build quality completion to stateless pickup. Shared input and observation helpers preserve phase isolation without new dependency cycles. Live end-to-end verification and post-Build finalization remain pending; this candidate is not delivery sign-off. |
| **v2.19.1** | **Stateless Design, Plan, and Build pickup — superseded unreleased candidate.** Introduced repository handoffs, remaining-work resume, BUILD-C submission and receipt-lineage validation. Missing native producer/consumer adapters and initial Design entry required the v2.19.2 wiring repair. Local installation and archive preparation did not establish end-to-end delivery or a public release. |
