...
NOT_RELEASED = {
    "2.24.0": {
        "reason": "Untagged native review simplification candidate, replaced by the restored advisory delivery flow and shared dashboard in 2.25.0. No version tag or archive release was published.",
        "superseded_by": "2.25.0"
    },
    "2.23.10": {
        "reason": "untagged review recovery source candidate; native source review simplification supersedes it in 2.24.0. Local archives and CI do not establish marketplace or tagged publication.",
        "superseded_by": "2.24.0"
    },
    "2.23.9": {
        "reason": "untagged shared-entry readiness source candidate; native child recovery, whole-repository review, and evidence corrections supersede it in 2.23.10. Package builds and a source push do not establish a tagged release.",
        "superseded_by": "2.23.10"
    },
    "2.23.8": {
        "reason": "untagged native startup and budget recovery source candidate; shared entry readiness and installed-package journey corrections supersede it in 2.23.9. Marketplace installation is separate from a tagged source release.",
        "superseded_by": "2.23.9"
    },
    "2.23.7": {
        "reason": "untagged native Codex integration source candidate; Claude initialization and approved budget recovery supersede it in 2.23.8. Marketplace installation is separate from tagged source release authority.",
        "superseded_by": "2.23.8"
    },
    "2.23.6": {
        "reason": "shared-initialization source candidate with no version tag or GitHub archive release. The installed Marketplace copy is distinct from tagged source release authority; native Codex integration is prepared in 2.23.7.",
        "superseded_by": "2.23.7"
    },
    "2.23.5": {
        "reason": "locally installed session-isolation candidate; no version tag or GitHub release was published. Shared entry initialization and tool compatibility are repaired in 2.23.6.",
        "superseded_by": "2.23.6"
    },
    "2.23.4": {
        "reason": "untagged standalone review startup candidate; local archives and installation did not establish a version tag or GitHub release. Session isolation and cross-checkout readiness are repaired in the 2.23.5 candidate.",
        "superseded_by": "2.23.5"
    },
    "2.23.3": {
        "reason": "untagged harness candidate on main; archive preparation and local installation did not establish a version tag or GitHub release. The standalone startup repair is prepared as the 2.23.4 candidate.",
        "superseded_by": "2.23.4"
    },
    "2.23.2": {
        "reason": "untagged budget and onboarding candidate on main; its changes are retained by the 2.23.3 harness release. No release tag or GitHub release was published for 2.23.2.",
        "superseded_by": "2.23.3"
    },
    "2.23.1": {
        "reason": "superseded untagged onboarding source candidate. Its fixes are included in the 2.23.2 budget and harness package; local installation did not establish a tagged release.",
        "superseded_by": "2.23.2"
    },
    "2.23.0": {
    ...
    "2.20.0": {
        "reason": "superseded local development version. PR #22 integrated "
                  ...
                  "2.20.0. The distinct post-refactor Marketplace candidate "
                  "is 2.23.0; local builds and installation did not publish "
                  "2.20.0 as a public release.",
        "superseded_by": "2.23.0",
    },
    "2.19.0": {
